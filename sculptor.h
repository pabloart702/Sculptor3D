...
public:
    ...
    void putVoxel(int x, int y, int z); //Ativa o voxel na posição (x,y,z) fazendo show = true e e atribuindo a cor atual
    void cutVoxel(int x, int y, int z); //Desativa o voxel na posição (x,y,z) fazendo show = false
    void putBox(int x0, int x1, int y0, int y1, int z0, int z1); //Ativa todos os voxels no intervalo x[x0,x1], y, e atribui aos mesmos a cor de desenho atual
    void cutBox(int x0, int x1, int y0, int y1, int z0, int z1); //Desativa todos os voxels no intervalo x[x0,x1], y, e atribui aos mesmos a cor de desenho atual
